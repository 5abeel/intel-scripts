/* p4c-pna-xxp version: 3.0.70.114 */ 
...
block SEM {
  ...
  domain 0 {
    ...
    tcam PROFILE(%PTYPE_GROUP, %VSI_GROUP, %SEM_MD2, %PORT) {
        ...
        @12 { 58, 'b???_????_????, 'h???0, 'b?? : 13; }
        @13 { 60, 'b???_????_????, 'h???0, 'b?? : 13; }
        @14 { 61, 'b???_????_????, 'h???0, 'b?? : 13; }
        @15 { 63, 'b???_????_????, 'h???0, 'b?? : 13; }
        @16 { 70, 'b???_????_????, 'h???0, 'b?? : 13; }
        @17 { 71, 'b???_????_????, 'h???0, 'b?? : 13; }
        @18 { 72, 'b???_????_????, 'h???0, 'b?? : 13; }
        @19 { 100, 'b???_????_????, 'h???0, 'b?? : 13; }
        @20 { 101, 'b???_????_????, 'h???0, 'b?? : 13; }
        @21 { 102, 'b???_????_????, 'h???0, 'b?? : 13; }
        @22 { 110, 'b???_????_????, 'h???0, 'b?? : 13; }
        @23 { 111, 'b???_????_????, 'h???0, 'b?? : 13; }
        @24 { 112, 'b???_????_????, 'h???0, 'b?? : 13; }
        @25 { 114, 'b???_????_????, 'h???0, 'b?? : 13; }
        @26 { 115, 'b???_????_????, 'h???0, 'b?? : 13; }
        @27 { 116, 'b???_????_????, 'h???0, 'b?? : 13; }
        @28 { 118, 'b???_????_????, 'h???0, 'b?? : 13; }
        @29 { 119, 'b???_????_????, 'h???0, 'b?? : 13; }
        @30 { 140, 'b???_????_????, 'h???0, 'b?? : 13; }
        @31 { 141, 'b???_????_????, 'h???0, 'b?? : 13; }
        @32 { 142, 'b???_????_????, 'h???0, 'b?? : 13; }
        @33 { 150, 'b???_????_????, 'h???0, 'b?? : 13; }
        @34 { 151, 'b???_????_????, 'h???0, 'b?? : 13; }
        @35 { 152, 'b???_????_????, 'h???0, 'b?? : 13; }
        @36 { 153, 'b???_????_????, 'h???0, 'b?? : 13; }
        @37 { 154, 'b???_????_????, 'h???0, 'b?? : 13; }
        @38 { 155, 'b???_????_????, 'h???0, 'b?? : 13; }
        @39 { 287, 'b???_????_????, 'h???0, 'b?? : 13; }
        @40 { 1, 'b???_????_????, 'h???0, 'b?? : 15; }
        @41 { 11, 'b???_????_????, 'h???0, 'b?? : 15; }
        @42 { 23, 'b???_????_????, 'h???0, 'b?? : 15; }
        @43 { 24, 'b???_????_????, 'h???0, 'b?? : 15; }
        @44 { 26, 'b???_????_????, 'h???0, 'b?? : 15; }
        @45 { 33, 'b???_????_????, 'h???0, 'b?? : 15; }
        @46 { 34, 'b???_????_????, 'h???0, 'b?? : 15; }
        @47 { 35, 'b???_????_????, 'h???0, 'b?? : 15; }
        @48 { 59, 'b???_????_????, 'h???0, 'b?? : 15; }
        @49 { 80, 'b???_????_????, 'h???0, 'b?? : 15; }
        @50 { 81, 'b???_????_????, 'h???0, 'b?? : 15; }
        @51 { 82, 'b???_????_????, 'h???0, 'b?? : 15; }
        @52 { 90, 'b???_????_????, 'h???0, 'b?? : 15; }
        @53 { 91, 'b???_????_????, 'h???0, 'b?? : 15; }
        @54 { 92, 'b???_????_????, 'h???0, 'b?? : 15; }
        @55 { 120, 'b???_????_????, 'h???0, 'b?? : 15; }
        @56 { 121, 'b???_????_????, 'h???0, 'b?? : 15; }
        @57 { 122, 'b???_????_????, 'h???0, 'b?? : 15; }
        @58 { 124, 'b???_????_????, 'h???0, 'b?? : 15; }
        @59 { 125, 'b???_????_????, 'h???0, 'b?? : 15; }
        @60 { 126, 'b???_????_????, 'h???0, 'b?? : 15; }
        @61 { 128, 'b???_????_????, 'h???0, 'b?? : 15; }
        @62 { 129, 'b???_????_????, 'h???0, 'b?? : 15; }
        @63 { 130, 'b???_????_????, 'h???0, 'b?? : 15; }
        @64 { 132, 'b???_????_????, 'h???0, 'b?? : 15; }
        @65 { 288, 'b???_????_????, 'h???0, 'b?? : 15; }
        @66 { 58, 'b???_????_????, 'h???4, 'b?? : 1; }
        @67 { 60, 'b???_????_????, 'h???4, 'b?? : 1; }
        @68 { 61, 'b???_????_????, 'h???4, 'b?? : 1; }
        @69 { 63, 'b???_????_????, 'h???4, 'b?? : 1; }
        ...
        @117 { 'b??_????_????, 1, 'b????_????_????_00?1, 'b?? : 10; }
        @118 { 1, 'b???_????_????, 'b????_????_?0??_00?1, 'b?? : 8; }
        @119 { 11, 'b???_????_????, 'b????_????_?0??_00?1, 'b?? : 8; }
        @120 { 23, 'b???_????_????, 'b????_????_?0??_00?1, 'b?? : 8; }
        @121 { 24, 'b???_????_????, 'b????_????_?0??_00?1, 'b?? : 8; }
        @122 { 26, 'b???_????_????, 'b????_????_?0??_00?1, 'b?? : 8; }
        @123 { 33, 'b???_????_????, 'b????_????_?0??_00?1, 'b?? : 9; }
        @124 { 34, 'b???_????_????, 'b????_????_?0??_00?1, 'b?? : 9; }
        @125 { 35, 'b???_????_????, 'b????_????_?0??_00?1, 'b?? : 9; }
        @126 { 58, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @127 { 59, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @128 { 60, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @129 { 61, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @130 { 63, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @131 { 70, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @132 { 71, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @133 { 72, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @134 { 80, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @135 { 81, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @136 { 82, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @137 { 90, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @138 { 91, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @139 { 92, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @140 { 100, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @141 { 101, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @142 { 102, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @143 { 110, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @144 { 111, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @145 { 112, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @146 { 114, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @147 { 115, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @148 { 116, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @149 { 118, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @150 { 119, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @151 { 120, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @152 { 121, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @153 { 122, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @154 { 124, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @155 { 125, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @156 { 126, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @157 { 128, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @158 { 129, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @159 { 130, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @160 { 132, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @161 { 140, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @162 { 141, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @163 { 142, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @164 { 150, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @165 { 151, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @166 { 152, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @167 { 153, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @168 { 154, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @169 { 155, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @170 { 287, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @171 { 288, 'b???_????_????, 'b????_?1??_?0??_01?1, 'b?? : 14; }
        @172 { 1, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @173 { 11, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @174 { 23, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @175 { 24, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @176 { 26, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @177 { 33, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @178 { 34, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @179 { 35, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @180 { 58, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @181 { 59, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @182 { 60, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @183 { 61, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @184 { 63, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @185 { 70, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @186 { 71, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @187 { 72, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @188 { 80, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @189 { 81, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @190 { 82, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @191 { 90, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @192 { 91, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @193 { 92, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @194 { 110, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @195 { 111, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @196 { 112, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @197 { 114, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @198 { 115, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @199 { 116, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @200 { 118, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @201 { 119, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @202 { 124, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @203 { 125, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @204 { 126, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @205 { 128, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @206 { 129, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @207 { 130, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @208 { 132, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @209 { 287, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @210 { 288, 'b???_????_????, 'b????_?0??_?0??_01?1, 'b?? : 14; }
        @211 { 1, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @212 { 11, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @213 { 23, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @214 { 24, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @215 { 26, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @216 { 33, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @217 { 34, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @218 { 35, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @219 { 58, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @220 { 59, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @221 { 60, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @222 { 61, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @223 { 63, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @224 { 70, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @225 { 71, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @226 { 72, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @227 { 80, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @228 { 81, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @229 { 82, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @230 { 90, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @231 { 91, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @232 { 92, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @233 { 110, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @234 { 111, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @235 { 112, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @236 { 114, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @237 { 115, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @238 { 116, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @239 { 118, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @240 { 119, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @241 { 124, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @242 { 125, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @243 { 126, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @244 { 128, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @245 { 129, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @246 { 130, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @247 { 132, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @248 { 287, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
        @249 { 288, 'b???_????_????, 'b????_?1??_?0??_10?1, 'b?? : 14; }
    ...
    table PROFILE_CFG(%PROFILE) {
		...
		4 : 
			...
			LUT {
				...
				OBJECT_ID(0), 
				MISS_ACTION0(3774988352), 
				MISS_ACTION1(1656437820), 
				MISS_ACTION2(1946157057), 
				MISS_ACTION3(3896508673), 
				EXTRACT {
					WORD0(229, 4, 'hFF), 
					WORD1(1, 0, 'hFFFF), 
					WORD2(1, 2, 'hFFFF), 
...
block HASH {
  ...
  domain 0 {
    ...
    tcam PROFILE(%PTYPE_GROUP, %VSI_GROUP, %MD_KEY) {
		...
		@1 { 2, 'b????_?, 'b????_????_????_???0 : 2; }
		@2 { 3, 'b????_?, 'b????_????_????_???0 : 3; }
		@3 { 10, 'b????_?, 'b????_????_????_???0 : 10; }
		@4 { 6, 'b????_?, 'b????_????_????_???0 : 10; }
		@5 { 4, 'b????_?, 'b????_????_????_???0 : 4; }
		@6 { 5, 'b????_?, 'b????_????_????_???0 : 5; }
		@7 { 3, 'b????_?, 'b????_????_???1_00?1 : 7; }
		@8 { 2, 'b????_?, 'b????_????_???1_00?1 : 7; }
		@9 { 1, 'b????_?, 'b????_????_???1_00?1 : 7; }
		@10 { 6, 'b????_?, 'b????_????_???1_00?1 : 8; }
		@11 { 5, 'b????_?, 'b????_????_???1_00?1 : 8; }
		@12 { 4, 'b????_?, 'b????_????_???1_00?1 : 8; }
		@13 { 10, 'b????_?, 'b????_????_??1?_00?1 : 9; }
		@14 { 3, 'b????_?, 'b????_????_??1?_00?1 : 9; }
		@15 { 2, 'b????_?, 'b????_????_??1?_00?1 : 9; }
		@16 { 1, 'b????_?, 'b????_????_??1?_00?1 : 9; }
		@17 { 6, 'b????_?, 'b????_????_??1?_00?1 : 9; }
		@18 { 5, 'b????_?, 'b????_????_??1?_00?1 : 9; }
		@19 { 4, 'b????_?, 'b????_????_??1?_00?1 : 9; }
		@20 { 10, 'b????_?, 'b????_????_????_00?1 : 11; }
		@21 { 3, 'b????_?, 'b????_????_????_00?1 : 11; }
		@22 { 2, 'b????_?, 'b????_????_????_00?1 : 11; }
		@23 { 1, 'b????_?, 'b????_????_????_00?1 : 11; }
		@24 { 6, 'b????_?, 'b????_????_????_00?1 : 11; }
		@25 { 5, 'b????_?, 'b????_????_????_00?1 : 11; }
		@26 { 4, 'b????_?, 'b????_????_????_00?1 : 11; }
		@4095 { 'b????, 'b????_?, 'h???? : 0; }
